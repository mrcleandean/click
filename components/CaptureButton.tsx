...
const PAN_GESTURE_HANDLER_FAIL_X = [-cameraConstants.screenWidth, cameraConstants.screenWidth]
const PAN_GESTURE_HANDLER_ACTIVE_Y = [-2, 2]

const START_RECORDING_DELAY = 200
const BORDER_WIDTH = cameraConstants.captureButtonSize * 0.1
...
const _CaptureButton: React.FC<Props> = ({
    ...
    const onPanGestureEvent = useAnimatedGestureHandler<PanGestureHandlerGestureEvent, { offsetY?: number; startY?: number }>({
        ...
        onActive: (event, context) => {
            ...
            const startY = context.startY ?? cameraConstants.screenHeight(insets)
...
const CaptureButton = React.memo(_CaptureButton)
...
const styles = StyleSheet.create({
    ...
    shadow: {
        ...
        borderRadius: cameraConstants.captureButtonSize / 2,
